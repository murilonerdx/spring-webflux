...
import com.github.murilonerdx.springwebflux.exceptions.InputFailedValidationResponse;
...
public class Lec06ExchangeTest extends BaseTest {
    ...
    private Mono<Object> exchange(ClientResponse cr) {
        if (cr.rawStatusCode() == 400) return cr.bodyToMono(InputFailedValidationResponse.class);
        else return cr.bodyToMono(ResponseDTO.class);
    }
